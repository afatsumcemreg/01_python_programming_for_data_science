...
df = pd.read_csv("C:/Users/test/PycharmProjects/miuul_data_sicence_bootcamp/datasets/persona.csv")
...
age_df['NEW_AGE'] = pd.cut(age_df["AGE"], bins, labels=mylabels)
age_df.head()
...
#############################################
# GÖREV 9: Yeni geln müsterileri siniflandiran bir fonksiyon tanimlayiniz ve ne kadar gelri getirecegini tahmin ediniz.
#############################################
...
new_user = customer_segementation('tur', 'ios', 'male', '19_23')
